    ...
    <table border=0 cellpadding=0 cellspacing=0 width=800>
      ...
      <td width=55> </td>
        ...
        <table border=0 cellpadding=4 width=80%>
          ...
          <tr valign=top>
            <td align=right width=25%><span class=smallb><b>Payment method</b></span></td>
            <td>
...
<%-- @version $Id: //edu/ILT-Courses/main/Commerce/StudentFiles/Commerce/setup/DynamusicB2B/j2ee-apps/dynamusicb2b-j2ee/dynamusicb2b.war/billing_invoice.jsp#9 $$Change: 514668 $--%>
