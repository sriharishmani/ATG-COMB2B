      ...
      <tr>
        ...
        <td valign="top">
          ...
          <dsp:form action="newProfile.jsp" method="post">
            ...
            <dsp:input bean="/atg/userprofiling/ProfileFormHandler.value.numberOfOrders" type="hidden" value="0"/> 
            <dsp:input bean="/atg/userprofiling/ProfileFormHandler.value.CumulativeOrderAmount" type="hidden" value="0"/> 
