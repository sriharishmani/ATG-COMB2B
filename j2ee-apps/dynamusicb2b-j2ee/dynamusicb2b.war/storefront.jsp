    ...
    <table width="700" cellpadding="8">
        <tr>
            ...
            <td valign="top"><font face="Verdana,Geneva,Arial" size="+1"
                                   color="midnightblue"> <dsp:importbean
                    bean="/atg/userprofiling/Profile"/> <%-- Checking to see if the user is logged in --%>
                <dsp:droplet name="/atg/dynamo/droplet/Switch">
                <dsp:param bean="/atg/userprofiling/Profile.transient" name="value"/>
                    <%-- User is logged in if false --%>
                <dsp:oparam name="false">

                <font face="Verdana,Geneva,Arial" size="+2" color="midnightblue"><dsp:valueof
                        bean="Profile.firstName"/>'s Categories</font>
                ...
                <p><dsp:getvalueof id="pageName" param="element.template.url"
                    ...
                    </dsp:droplet> <%-- NOTE: The Motorprise application has a scenario to set the
